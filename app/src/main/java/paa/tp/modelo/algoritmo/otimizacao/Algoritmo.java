...
public abstract class Algoritmo {
    ...
    public Algoritmo(final List<PontoCandidato> listaPontosCandidatos, final double distanciaMinima) {
        ...
        this.distanciaMinimaPermitida = distanciaMinima;
    }
    ...
    protected boolean verificarOtimizacao(final Solucao solucao) {
        return melhorSolucao == null || solucao.getQuantidadePontos() > melhorSolucao.getQuantidadePontos() || (solucao.getQuantidadePontos() == melhorSolucao.getQuantidadePontos() && solucao.getCustoTotal() < melhorSolucao.getCustoTotal());
    }
}
